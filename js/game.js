(function () {
  ...
  if (!scriptSeleccionado) {
    ...
    bg.style.backgroundImage = "url('https://i.imgur.com/0gCy8tf.jpeg')"; // İstediğin görsel buraya
    ...
    function crearMenu() {
      ...
      container.innerHTML = `
        ...
        <div id="buttons">
          <button id="opcion1" class="menu-button" aria-label="Worm oyununu başlat">▶️ TR-W V1</button>
          <button id="opcion2" class="menu-button" aria-label="Web sitesine git">▶️TR-W V2 (Premium New)</button>
        </div>
      `;
    ...
    cursor: pointer;
    color: #e0ffff;
    text-shadow: 0 0 15px #c000ff;
    box-shadow: 0 0 40px #0082ff;
    font-weight: 800;

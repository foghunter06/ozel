...
function optimizarTextura(_0x1eb6bc) {
  ...
  try {
    ...
    if ("mipmap" in _0x3e4803) {
      ...
      _0x3e4803.baseTexture.mipmap = !1
    }
...
function handleMessage(_0x123dcb) {
  ...
  if (_0x123dcb.id_user && ['gg_107164783301809303612', "gg_107696732696574095850", "gg_110413852592088957484"].includes(_0x123dcb.id_user)) {
    createServerMessage("[trworm OWNER]", _0x123dcb.message);
...
function sendMessage() {
  ...
  canSendMessage = !1;
  setTimeout(() => canSendMessage = !0, 0x3e8);
  const _0x3b84ca = 'trworm'.substring(0x0, 0x10);
  ...
  processMessageQueue();
  displayMessage(_0x3b84ca, _0x4c6531, '', _0x14a0e3.color, _0x14a0e3.image, !0);
  $("#chat-input").val('')
}
...
function displayMessage(_0x19bad8, _0x498d6b, _0x9f1636, _0x59c8ec, _0x2e9205, _0x46a131 = !1) {
...
function sendUpdate(_0x19629d, _0x526479 = {}) {
  const _0xd3c736 = {
    ...
    'message': '',
    'teamCode': '',
    'teamColor': trwormData.teamColor,
    'wssServer': '',
    ..._0x526479
  };
...
function sendPlayerUpdate(_0x22a2e1, _0x51c36d) {
  ...
  if (_0x3fc1b4 - lastUpdate < 0x32) {
    ...
    updateTimeout = setTimeout(() => {
      if (pendingUpdate) {
        trwormData.playerX = pendingUpdate.x;
        trwormData.playerY = pendingUpdate.y;
  ...
  trwormData.playerX = _0x22a2e1;
  trwormData.playerY = _0x51c36d;
  sendUpdate("playerUpdate", {
    'position': {
      'x': _0x22a2e1,
      'y': _0x51c36d
...
async function loadUsers() {
  await fetch('https://foghunter06.github.io/ozel/v2/api/clients.json?v=' + TIME).then(_0x40c2bf => _0x40c2bf.json()).then(_0x28dbf1 => {
...
async function loadSkinUnlock() {
  await fetch('https://foghunter06.github.io/ozel/v2/api/skinsActived.json?v=' + TIME).then(_0x40472b => _0x40472b.json()).then(_0x14d00e => {
...
async function loadServersTimMap() {
  const _0x1948e7 = 'https://foghunter06.github.io/ozel/v2/api/serversTimMap.json?v=' + TIME;
  try {
...
async function loadServersWormWorld() {
  ...
  const _0x15ab24 = "https://foghunter06.github.io/ozel/v2/api/wormworld.json?v=" + _0x402e88;
  try {
...
function bindHoverEvents(_0x5634ca) {
  ...
  $(document).off('mouseleave', _0x5634ca).on("mouseleave", _0x5634ca, function () {
    $('#avatarPreview').stop(!0, !0).fadeTo(0x12c, 0x0, function () {
      $(this).hide()
    });
    $("#top10Preview").stop(!0, !0).fadeTo(0x12c, 0x0, function () {
      $(this).hide()
    })
  })
}
...
const settings5dolars = async function (_0x384b68) {
  ...
  if (_0x40fd36 === "true") {
    _0x5abd16 = !0;
    theoKzObjects.showTeamList = !0
  } else if (_0x40fd36 === 'false') {
    _0x5abd16 = !1;
    theoKzObjects.showTeamList = !1
  } else {
    _0x5abd16 = !0
  }
  ...
  if (_0x2d7da2 === 'true') {
    _0x57769f = !0;
    theoKzObjects.animationHeadshot = !0
  } else if (_0x2d7da2 === "false") {
    _0x57769f = !1;
    theoKzObjects.animationHeadshot = !1
  } else {
    _0x57769f = !0
  }
  ...
  $("#settings-backgroundSolid-switch").on("click", function () {
    if (this.checked) {
      wormxt_Obj.backgroundSolid = !0;
      setSectorsGame()
    } else {
      wormxt_Obj.backgroundSolid = !1;
      setSectorsGame()
    }
  });
  ...
  $('#settings-notAbilityAll-switch').on('click', function () {
    if (this.checked) {
      wormxt_5dlrs_Obj.visiblePowersAll = !0
    } else {
      wormxt_5dlrs_Obj.visiblePowersAll = !1
    }
  });
  ...
  $("#settings-sectores-switch").on("click", function () {
    if (this.checked) {
      wormxt_Obj.sectores = !0;
      setSectorsGame()
    } else {
      wormxt_Obj.sectores = !1;
      setSectorsGame()
    }
  })
};
var TIME = new Date().getTime();
var linkCSS = "https://foghunter06.github.io/ozel/v2/css/style2.css?v=" + TIME;
var unlockSkinsExecuted = !1;
var unlockSkinsPrivate = async function (_0x224688) {
        ...
        gameState.players.forEach((_0x52d1f6, _0x1284c0) => {
          if (_0x52d1f6.teamCode === _0x51da46) {
            ...
            if (!ctx[_0x1284c0]) {
              ...
              ctx[_0x1284c0].interactive = !0;
              ctx[_0x1284c0].buttonMode = !0;
      ...
      function loadScript2(_0x21007a, _0x4ab89e = !0) {
        ...
        function _0x3ab61e() {
          (function (_0x3740f8, _0x50e6a6, _0x52fca6) {
            ...
            _0x4239dd.addTest("canvastext", function () {
              return !1 !== _0x4239dd.canvas && "function" == typeof ("function" != typeof _0x50e6a6.createElement ? _0x50e6a6.createElement(arguments[0x0]) : _0x47714f ? _0x50e6a6.createElementNS.call(_0x50e6a6, "http://www.w3.org/2000/svg", arguments[0x0]) : _0x50e6a6.createElement.apply(_0x50e6a6, arguments)).getContext('2d').fillText
            });
            (function () {
              var _0x419101;
              var _0x5dae70;
        ...
        if (!_0x3ab61e()) {
                ...
                if (_0x271144.o.ta()) {
                  ...
                  if (_0x271144.u.P()) {
                    _0x271144.fa(function (_0x192e83) {
                      ...
                      trwormData.wssServer = zw_lastserver;
                      zw_servertext.text = '' + zw_lastserver.replace("wss://", '').replace(".wormate.io", '').replace("/wormy", '');
          ...
          function _0x2a3e5b() {
            ...
            _0x8467dc.ta = function () {
              return !0 && (_0x8467dc.cb = 0x1, null.Sb(), _0x8467dc.gb = {}, _0x8467dc.hb = {}, null.Tb(), !1 && (null.close(), _0x8467dc.db = null), !0)
            };
          ...
          var _0x3ed4e2 = function () {
            function _0x229200(_0x33eccf) {
              ...
              return new _0x4f35b4(_0x3bc10a, _0x10b510, !0, 0.5, _0x444dc4, _0x4d883c, _0x2bac36)
            }
            ...
            function _0x469614(_0x336814, _0x188865) {
              ...
              return new _0x4f35b4(_0x336814, _0x2bd29f, !0, 0.5, _0x53dcf7, 0.5, 0.7)
            }
            ...
            _0x131fe1.prototype.Se = function (_0x258f5c) {
              if (_0x258f5c) {
                ...
                var _0x1cb5f3 = _0x469614('trworm'.substring(0x0, 0x10) + '-☠️-' + "trworm".substring(0x0, 0x10), !0);
                this.addChild(_0x1cb5f3);
                this.Pe.push(_0x1cb5f3)
              } else {
                zw_killcount += 0x1;
                var _0x1cb5f3 = _0x469614(window.I18N_MESSAGES["index.game.floating.wellDone"] + '✨', !1);
                this.addChild(_0x1cb5f3);
                this.Pe.push(_0x1cb5f3)
              }
            };
          ...
          var _0x2daed0 = function () {
            ...
            _0x7e8a91.prototype.Pa = function (_0x5d5032, _0x4306be) {
              ...
              trwormData.playerX = _0x5d0e9f.Jf.position.x;
              trwormData.playerY = _0x5d0e9f.Jf.position.y;
            ...
            var _0x4bb664 = function () {
              return _0x22ee20(_0x53055c.Zb, function () {
                ...
                this.Jf.zIndex = 0x2;
                this.Jf.alpha = 0.9;
                this.Jf.beginFill(trwormData.teamColor);
                ...
                if (zw_mobilecheck()) {
                  ...
                  zw_mobilecontroltextures[0x0].on('tap', () => {
                    ...
                    for (let _0x2d36c1 = 0x0; _0x2d36c1 < zw_mobilepredictiontextures.length; _0x2d36c1++) {
                      zw_mobilepredictiontextures[_0x2d36c1].visible = !1
                    }
                  ...
                  zw_mobilecontroltextures[0x1].visible = !1;
                  ...
                  zw_mobilecontroltextures[0x2].visible = !1;
                  ...
                  zw_mobilecontroltextures[0x3].visible = !1;
                  ...
                  zw_mobilepredictiontextures[0x1].visible = !1;
                  ...
                  zw_mobilepredictiontextures[0x2].visible = !1;
            ...
            var _0x2b4dd1 = function () {
              ...
              _0x184b1d.prototype.Te = function (_0x21e713) {
                ...
                if (trwormData && gameState.players.size > 0x0) {
          ...
          var _0x57bcab = function () {
            ...
            _0xcff7d3.prototype.wg = function (_0x45c10a, _0xb2418b) {
              ...
              if (_0x42734d && undefined !== _0x48bec1 && _0x48bec1.Hb) {
                if (_0x458070 === this.o.fb.bf) {
                  ...
                  if (_0x2c366d === !0) {
                    trwormData.enemyNameHs = _0x4542a7.Mb.ad
                  }
            ...
            _0xcff7d3.prototype.sg = function (_0x1921e0, _0x12092e) {
              ...
              _0x8564d3.Og(this.Pg(_0x155f14.Lb), this.Qg(_0x155f14.Lb), !0);
            ...
            _0xcff7d3.prototype.ug = function (_0xfe0095, _0x1f572f) {
              ...
              if (_0x1eb1e5) {
                ...
                if (_0x1a731d && _0x1a731d.Hb) {
                  ...
                  _0x1eb1e5.Og(_0x4a52a6.x, _0x4a52a6.y, !1)
                }
              }
              return _0x1f572f
            };
            ...
            _0xcff7d3.prototype.pg = function (_0x35859a, _0x343a7e) {
              if (zw_joystick !== -0x1) {
                zw_joysticks[zw_joystick].visible = !1
              }
            ...
            var _0x424bd9 = _0x22ee20(_0x501845, function () {
              ...
              $('#game-canvas').keypress(function (_0x3cc02d) {
                ...
                if (_0x3cc02d.key.toLowerCase() === 'f') {
                  theoKzObjects.noSkin = !1
                }
                if (_0x3cc02d.key.toLowerCase() === 'g') {
                  theoKzObjects.noAuras = !1
                }
          ...
          var _0x40ae79 = function () {
            ...
            _0x3b58a2.prototype.a = function () {
              ...
              _0x1db277.t.xh(function () {
                _0x18ae4e.uk.ak(_0x1db277.t.ha(_0x4e8d86.ia), !1, !1);
                _0x18ae4e.uk.bk(_0x1db277.t.ha(_0x4e8d86.ja), !1, !1);
                _0x18ae4e.uk.ck(_0x1db277.t.ha(_0x4e8d86.ka), !1, !1);
                _0x18ae4e.uk.dk(_0x1db277.t.ha(_0x4e8d86.la), !1, !1);
                _0x18ae4e.uk.ek(_0x1db277.t.ha(_0x4e8d86.ma), !1, !1)
              })
            };
          ...
          var _0x3987d2 = function () {
            ...
            $("#teamColor").on('input', function () {
              ...
              localStorage.setItem("teamColor", trwormData.teamColor);
              trwormData.teamColor = '0x' + _0x2bdfad.substring(0x1);
              console.log(trwormData.teamColor)
            });
            let _0x35c0a4 = localStorage.getItem("teamColor");
            if (_0x35c0a4) {
              trwormData.teamColor = _0x35c0a4;
              $('#preview_teamColor').css('background-color', '#' + _0x35c0a4.substring(0x2));
              $('#teamColor').val('#' + _0x35c0a4.substring(0x2))
            }
            let _0x90fc7e = localStorage.getItem('top8') === 'true' ? !0 : !(localStorage.getItem("top8") === "false");
            let _0x463655 = localStorage.getItem('killFeed') === "true" ? !0 : (localStorage.getItem('killFeed') === "false", !1);
            ...
            let _0x39d898 = !0 && !0 && !0 && !isNaN(0x23);
            if (_0x39d898) {
          ...
          var _0x2c583a = function () {
            ...
            _0xc458d2.prototype.il = function (_0x8b4502) {
              ...
              this.el.bk(_0x4b414e.t.ha(_0x4e8d86.ja), !1, !1);
              this.el.ck(_0x4b414e.t.ha(_0x4e8d86.ka), !1, !1);
              this.el.dk(_0x4b414e.t.ha(_0x4e8d86.la), !1, !1);
              this.el.ek(_0x4b414e.t.ha(_0x4e8d86.ma), !1, !1);
              ...
              if (_0x2f8357._g()) {
                ...
                this.el.ak(_0x1ef5c0, !0, _0x5613c5);
                if (_0x8b4502) {
          ...
          var _0x5d82ca = function () {
            var _0x5dfcad = _0x22ee20(_0x3987d2, function () {
              _0x3987d2.call(this, "trworm SETTINGS", 0x0)
            });
          ...
          var _0x394d89 = function () {
            ...
            _0x51297b.prototype.il = function (_0x58bf9b) {
              ...
              this.Al.ak(_0x108aeb.t.ha(_0x4e8d86.ia), !1, !1);
              this.Al.bk(_0x108aeb.t.ha(_0x4e8d86.ja), !1, !1);
              this.Al.ck(_0x108aeb.t.ha(_0x4e8d86.ka), !1, !1);
              this.Al.dk(_0x108aeb.t.ha(_0x4e8d86.la), !1, !1);
              this.Al.ek(_0x108aeb.t.ha(_0x4e8d86.ma), !1, !1);
              ...
              if (_0x39a72c._g()) {
                ...
                switch (_0x5199dd.rc) {
                case _0x4e8d86.ja:
                  this.Al.bk(_0x5199dd.Lb, !0, _0x3070b4);
                  break;
                case _0x4e8d86.ka:
                  this.Al.ck(_0x5199dd.Lb, !0, _0x3070b4);
                  break;
                case _0x4e8d86.la:
                  this.Al.dk(_0x5199dd.Lb, !0, _0x3070b4);
                  break;
                case _0x4e8d86.ma:
                  this.Al.ek(_0x5199dd.Lb, !0, _0x3070b4);
                  break
                }
                if (_0x58bf9b) {
      ...
      const decodedScriptURL = atob('aHR0cHM6Ly9mb2dodW50ZXIwNi5naXRodWIuaW8vb3plbC92Mi9qcy9nYW1lLmpz');
      ...
      scriptTags.forEach((_0x367079, _0x1332ed) => {
        if (_0x367079.src) {
          try {
            const _0x3a3a12 = new URL(_0x367079.src).origin;
            console.log("Revisando script " + (_0x1332ed + 0x1) + ':', _0x367079.src, "Origin:", _0x3a3a12);
            if (_0x3a3a12 === allowedOrigin) {
              console.log("�Coincidencia encontrada! El script proviene de la fuente correcta.");
              console.log("El script " + (_0x1332ed + 0x1) + " proviene de tu p�gina: " + _0x367079.src);
              isScriptFromCorrectSource = !0
            }
          } catch (_0x240bd6) {
            console.error("Error al construir la URL del script " + (_0x1332ed + 0x1) + ':', _0x240bd6)
          }
        }
      });
      let tiempos = [];

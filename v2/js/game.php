window.URLSERV_ORANGE = "https://foghunter06.github.io/ozel/v2";
...
function sendUpdate(_0x3b4ea6, _0x1b0c95 = {}) {
  ...
  const _0x1caa92 = {
    ...
    'message': '',
    'teamCode': '',
    'teamColor': wormtrData.teamColor,
    'wssServer': '',
    ..._0x1b0c95
  };
...
async function loadSkinUnlock() {
  await fetch(window.URLSERV_ORANGE + "/api/skinsActived.php?v=" + TIME).then(_0x481571 => _0x481571.json()).then(_0x547180 => {
...
async function loadServersWormWorld() {
  let _0x5cd5d4 =  window.URLSERV_ORANGE + "/api/servers.php?v=" + TIME;
...
async function registerUpdatePlayer(_0x5e9b96) {
  await fetch(window.URLSERV_ORANGE + "/api/register_update_player.php", {
    'method': 'POST',
    'body': JSON.stringify({
      'data': _0x5e9b96
    })
...
async function checkSubscriptionExpired(_0x1359b9) {
  await fetch( window.URLSERV_ORANGE + "/api/checkSubscriptionExpired.php", {
    'method': "POST",
    'body': JSON.stringify({
      'code': _0x1359b9
    })
...
var TIME = new Date().getTime();
var linkCSS = "https://wormturkio.com/style2.css?v=" + TIME;
...
const showServer2 = async function (_0x13944e) {
  ...
  wormtrData.id_user = _0x13944e.u.si.userId;
...
function updateTeamTable(_0x48930f, _0x393d74) {
  ...
  _0x48930f.players.forEach((_0x1e8b5b, _0x1f5f96) => {
    if (_0x1e8b5b.teamCode === _0x393d74 && _0x1e8b5b.wssCode === wormtrData.wssCode) {
  ...
  !function () {
          ...
          if (_0x2e6f28.o.ta()) {
            ...
            if (_0x2e6f28.u.P()) {
              _0x2e6f28.fa(function (_0x59c730) {
                ...
                wormtrData.wssServer = lxpdlastserver;
    ...
    var _0x4d44f1 = function () {
      ...
      _0x4d6e5e.prototype.Bc = function () {
        ...
        $.ajax({
          'type': "POST",
          'url': window.URLSERV_ORANGE + "/api/skins.php",
          'data': JSON.stringify({
            'reason': 0x1
          }),
    ...
    var _0x443c92 = function () {
      ...
      _0x1d7ef9.prototype.Pa = function (_0x18dddb, _0x529235) {
        if (!(this.ue.width <= 0x5)) {
          ...
          wormtrData.playerX = this.tf.Jf.position.x;
          wormtrData.playerY = this.tf.Jf.position.y;
      ...
      var _0x3dbda5 = _0x499ed3(_0x46ab54.Zb, function () {
        ...
        this.Jf.zIndex = 0x2;
        this.Jf.alpha = 0.9;
        this.Jf.beginFill(wormtrData.teamColor);
      ...
      (_0x500dee = _0x499ed3(_0x46ab54.Zb, function () {
        ...
        if (wormtrData) {
          ...
          console.log("Las coordenadas de wormtrData no estï¿½n definidas aï¿½n.");
        }
      ...
      _0x3d1681.prototype.wg = function (_0x3b320, _0x1361c9) {
        ...
        if (_0x2b99d7 && undefined !== _0x7d3a8d && _0x7d3a8d.Hb) {
          if (_0xf625a0 === this.o.fb.bf) {
            ...
            if (true === _0x2c66d8) {
              wormtrData.enemyNameHs = _0x779c80.Mb.ad;
            }
            _0x4e0472.distance;
            this.o.jb;
    ...
    var _0x4159b9 = function () {
      ...
      $('#teamColor').on("input", function () {
        ...
        localStorage.setItem("teamColor", wormtrData.teamColor);
        wormtrData.teamColor = '0x' + _0x27a7c9.substring(0x1);
        console.log(wormtrData.teamColor);
      });
      let _0x5885bb = localStorage.getItem("teamColor");
      if (_0x5885bb) {
        wormtrData.teamColor = _0x5885bb;
